...
// OLD ID const SHEET_ID = '19nNWdVnYdW1vEv0E0zAzVBSNc5DQKebAia7LD3fMv_o';
const SHEET_ID = '2PACX-1vSVt9JJkpqqbDGXFf8tb4edmC3BZP2cVeVAGfoPba5pt29LE1hh6aaFsGshfgMKUuGo2T5t5TxLBp3A';
    ...
    chartRef.current = new Chart(canvasRef.current, {
      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: {
            callbacks: {
              label: ctx => ctx.dataset.label === 'Rata-rata'
